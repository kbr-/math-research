...
| --- | --- | --- | --- |
| H01 | Finite augmented chain API for downward-closed families of finite faces, specialized to chessboard matchings. | — | Verified in [AugmentedChains.lean](third-party-claims/AugmentedChains.lean): empty face, finite supported coefficient spaces, exact-face linear equivalence, and boundary linearity. H03 supplies the original-boundary bridge. |
