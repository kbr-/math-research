...
Section~\ref{sec:upper} (exact degree, the factors of \(F\)), Section~\ref{sec:second-proof} (one more dimension)
...
Arithmetic of \(D(n,k)\): Sections~\ref{sec:introduction}, \ref{sec:main}
and~\ref{sec:second-proof}
...
cd bmd-check
git checkout --detach 168a0c8eef547709b4c0a18115ff97b01c20200d
cd formalization
...
The target is an import-only module whose header lists 64 declarations: the
...
author's machine in 204 seconds, on sources identical to the pinned commit.
