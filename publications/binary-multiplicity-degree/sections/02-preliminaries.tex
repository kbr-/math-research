...
\(f_d\ne0\). If \(z_i\) (\(i\in\sigma\)) are elements of a polynomial ring over
\(\F\) without constant term, then substituting
\(x_i\mapsto z_i\) does not lower the order: a monomial of degree \(d\) goes to a
product of \(d\) elements of order at least one. Hence
\(\mult_a(P)\ge m\) implies \(\operatorname{ord}P(a+z)\ge m\) for every such
substitution \(z\).
