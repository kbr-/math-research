...
- Restore with `python3 tools/resume.py`, then read its listed bounded parts.
  ...
  The bundle includes `research/notes/RESUME.md`, the computation and research-folder rules,
  notebook living sections/gaps and compact contents; this file is not bundled, since the harness
