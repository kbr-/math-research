...
In terms of \(n\) the bound is \(2^{\Omega(n/\log^2n)}\). The constant
...
\(\Res\) is the characteristic-two member of the family
\(\mathrm{Res}(\mathrm{lin}_R)\) of resolution over linear equations in a
ring \(R\), introduced by Raz and Tzameret \cite{RT08}. Part and Tzameret
...
\subsection{Changes in revision 1}
...
\href{https://github.com/kbr-/math-research/tree/b47e9b1ef1f5b273822001983e83d35d7acbe117}{\texttt{b47e9b1}}, rather than a moving
