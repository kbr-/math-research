...
\begin{lemma}[Complete moment equations]\label{lem:marginals}\lean{claims/MatchingNormalForm.lean}\lean{claims/MatchingMomentCompleteness.lean}
...
\begin{theorem}[Extension of prescribed matching moments]\label{thm:moments}\lean{claims/MatchingMomentExtension.lean}\lean{claims/MatchingFiltration.lean}
