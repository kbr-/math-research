...
- Verification map: every cited declaration name was checked against the Lean sources by
  ...
  at commit 4f43ed20 (`research/results/bmd-f2-paper-v2/lean-verification-paper2.txt`).

## Outstanding

- The Lean links and the reproduction commands point to commit 4f43ed20, which exists only
