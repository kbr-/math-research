...
Schwartz--Zippel lemma and a one-dimension reduction. All numbered results and
their dependencies are formalized in Lean~4, and an appendix maps each to its
formal proof.
\end{abstract}
\clearpage
