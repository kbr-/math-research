...
with tempfile.TemporaryDirectory(prefix='multiplicity-note-qa-') as tmp:
    ...
    for target in ('https://doi.org/10.1006/eujc.1993.1011', 'https://doi.org/10.1137/100783704', 'https://doi.org/10.1017/S0963548323000123', 'https://arxiv.org/abs/2101.11947v1', 'https://github.com/kbr-/math-research/blob/main/publications/binary-polynomial-multiplicity/DEVELOPMENT_HISTORY.md'):
