...
\newcommand{\leancommit}{86d8a6ba5ea9e9313dacbe06e6ce3bce278e5db3}
...
\]
Menezes determined \(\delta\) over every field for \(n\ge k-1\); in
...
\(2^n-1\) affine hyperplanes that avoid the origin. The lower bound expands a
...
modulo the vanishing polynomial of this span exposes the lowest part of the
polynomial at the origin. Minimizing over \(\ell\) gives the least degree
...
Schwartz--Zippel lemma and a one-dimension reduction. All results and their
dependencies are formalized in Lean~4, and every statement links to its
formal proof.
\end{abstract}
\clearpage
