...
This appendix gives the proof of the lower half of Corollary~\ref{cor:main} from
...
\(k\ge2^{n-1}\). The second formal proof of Lemma~\ref{lem:minimum} uses this
route.
...
prescribed origin order. By Corollary~\ref{cor:main} and
Theorem~\ref{thm:main}, both inequalities hold for every \(k\ge1\)
...
is below \(k\), and the degree is at most \(a(2^n-1)+2b=2k-a\).
