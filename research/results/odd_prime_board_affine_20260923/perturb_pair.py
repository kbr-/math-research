...
plane AG(2,3) minus a point) and replace the row functions of both forms on s randomly chosen rows by uniform random ones.
...
for s in ss:
    for tr in range(trials):
        ...
        for f in F: f[rows] = rng.integers(0, 3, size=(s, n))
