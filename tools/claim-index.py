...
def main():
    ...
    sub.add_parser('duplicates', add_help=False, help='Lexical duplicate candidates among claims')
    ...
    if args.command in ('duplicates', 'author'):
        tool = 'claim_duplicates.py' if args.command == 'duplicates' else 'claim_authoring.py'
