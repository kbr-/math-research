...
digits of \(r\) \lean{claims/PerOrderLegendre.lean}.
\end{lemma}
...
classical formula \(\sum_{j\ge1}\lfloor r/2^j\rfloor=r-s_2(r)\) for the \(2\)-adic
valuation of \(r!\), plus the term \(j=0\); by induction, for \(r=2r'+b\) with
...
also when \(k-\ell-1\ge2^n\), where Theorem~\ref{thm:construction} does better.
...
Theorem~\ref{thm:construction} optimal in every dimension.
