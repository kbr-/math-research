...
3. Read each entry's relevant scope, including unindexed entries and negative
   ...
   Apply the shared [significance check](../research/claims/README.md#significance-check-and-attention),
   including its comparison of formalization generalizations with their sources.
